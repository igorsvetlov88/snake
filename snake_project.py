...
countBodyW = WIDTH / BODYSIZE  # сколько сегментов в ширине
countBodyH = HEIGHT / BODYSIZE  # сколько сегментов в высоте
